...
HTML;
   ...
   <div>
    ...
    Paginate("SELECT COUNT(p_id) FROM products WHERE product_category = 'protective_gear' ","SELECT * FROM products WHERE product_category = 'protective_gear' ORDER BY p_id ASC ");
    echo '<h1 class="center_heading"> Protective Gear </h1>';
