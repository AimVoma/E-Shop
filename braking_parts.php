...
HTML;
   ...
   <div>
    ...
    Paginate("SELECT COUNT(p_id) FROM products WHERE product_category = 'braking_parts' ","SELECT * FROM products WHERE product_category = 'braking_parts' ORDER BY p_id ASC ");
    echo '<h1 class="center_heading"> Braking Parts </h1>';
