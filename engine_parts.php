...
HTML;
   ...
   <div>
    ...
    Paginate("SELECT COUNT(p_id) FROM products WHERE product_category = 'engine_parts' ","SELECT * FROM products WHERE product_category = 'engine_parts' ORDER BY p_id ASC ");
    echo '<h1 class="center_heading"> Engine Parts </h1>';
